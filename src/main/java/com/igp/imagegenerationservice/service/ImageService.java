...
import com.igp.imagegenerationservice.model.FalImageResult;
...
public class ImageService {
    ...
    public void pollPendingJobs() {
        ...
        FalImageResult resp = gson.fromJson(falAIModelService.returnResults("74decbb3-2bb5-40cb-a24c-c3f2ade01072", "fal-ai/flux/dev"), FalImageResult.class);

        String url = resp.getImages().get(0).getUrl();
...
//                Map<String, ?> falResult = falAIModelService.returnResults(job.getRequestId().toString(), job.getModelName());
//                String test = "";
            }
        }
    }
