...
public class ModelMapper {
    public static ModelResponseDTO mapToModelResponseDTO(Model model) {
        return ModelResponseDTO.builder().
                ...
                age(model.getAge()).gender(model.getGender()).zipUrl(model.getZipUrl()).isOpen(model.getIsOpen()).
    ...
    public static Model mapFromModelRequestDTO(ModelRequestDTO modelRequestDTO) {
        return Model.builder().name(modelRequestDTO.getName()).ethnicity(modelRequestDTO.getEthnicity()).zipUrl(modelRequestDTO.getZipUrl()).
